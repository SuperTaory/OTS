...
<body>
	<div style="margin-left:80px">
		<h3>添加试题-所属卷子id<%=eid%></h3>
		<h4><a href="${pageContext.request.contextPath }/test/update_question.action?eid=<%=eid %>">上一级</a></h4>
	</div>
	<form class="form-horizontal" enctype="multipart/form-data"
		action="${pageContext.request.contextPath }/test/addQuestionSubmit.action?eid=<%=eid %>"
		method="post">
